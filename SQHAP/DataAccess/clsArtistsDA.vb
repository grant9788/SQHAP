...
Public Class clsArtistsDA
    ...
    Public Shared Function GetRecords() As DataSet
        ...
        Catch ex As Exception
            MessageBox.Show("Error occurred in Class: clsArtistsDA. Method: GetRecords(). Error: " _
                            & ex.Message)
            Return Nothing
        Finally
    ...
    Public Shared Function DeleteRecord(ByVal aPrimaryKey As String) As Integer
        ...
        Try
            ...
            Return intResult
        Catch ex As Exception
            MessageBox.Show("Error occurred in Class: clsArtistsDA. Method: DeleteRecord(String). Error: " _
                            & ex.Message)
            Return -9
        Finally
            CloseDb(dbConnection)
    ...
    Public Shared Function AddRecord(ByVal aArtist As clsArtists) As Integer
        ...
        Try
            ...
            ' create a SQL string
            Dim strQuery As String
            strQuery = "INSERT INTO Artist ([ArtistID], [FirstName], [LastName], [PhoneNumber], [Email], 
                        [WebPage], [AIR]) VALUES (?, ?, ?, ?, ?, ?, ?)"
            ...
            dbCommand.Parameters.Add(New OleDbParameter("@FirstName", aArtist.FirstName))
            dbCommand.Parameters.Add(New OleDbParameter("@LastName", aArtist.LastName))
            dbCommand.Parameters.Add(New OleDbParameter("@PhoneNumber", aArtist.PhoneNumber))
            dbCommand.Parameters.Add(New OleDbParameter("@Email", aArtist.Email))
            dbCommand.Parameters.Add(New OleDbParameter("@WebPage", aArtist.WebPage))
            ...
            Return intResult
        Catch ex As Exception
            MessageBox.Show("Error occurred in Class: clsArtistsDA. Method: AddRecord(Object). Error: " _
                            & ex.Message)
            Return -9
        Finally
            CloseDb(dbConnection)
    ...
    Public Shared Function UpdateRecord(ByVal aArtist As clsArtists) As Integer
        ...
        Try
            ...
            ' create a SQL string
            Dim strQuery As String
            strQuery = "UPDATE Artist SET [FirstName] = ?, [LastName] = ?, [PhoneNumber] = ?,
                        [Email] = ?, [WebPage] = ?, [AIR] = ? WHERE [ArtistID] = ?"
            ...
            Return intResult
        Catch ex As Exception
            MessageBox.Show("Error occurred in Class: clsArtistsDA. Method: UpdateRecord(Object). Error: " _
                            & ex.Message)
            Return -9
        Finally
            CloseDb(dbConnection)
